export function getExpectedResults() {
  /**
   * @function getExpectedResults() returns the results expected from the main browser-report.js file.
   *
   * This function returns all the results that are expected from the browser report javascript file during testing.
   *
   * @return {Array} expected results list.
   */
  return [
    {
    ...
    },
    {
      ...
      userAgent:
        "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2393.94 Safari/537.36 OPR/42.0.2393.94",
      expectedReport: {
        browser: {
          name: "Opera",
    ...
    },
    {
      ...
      userAgent:
        "Mozilla/5.0 (Linux; Android 7.0; SAMSUNG SM-J330FN Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/7.2 Chrome/59.0.3071.125 Mobile Safari/537.36",
      expectedReport: {
        browser: {
          name: "Samsung Internet",
          version: "7.2"
    ...
    },
    {
      device: "Samsung",
      userAgent:
        "??? What is the Samsung OS? It's not Tizen and I don't believe it's Bada.",
      expectedReport: {
        browser: {
          name: "",
          majorVersion: ""
