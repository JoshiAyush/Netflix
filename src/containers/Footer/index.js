        ...
        <FooterContainer>
            ...
            <FooterContainer.Row>
                ...
                <FooterContainer.Column>
                    ...
                    <FooterContainer.Link href="#">Investor Relations</FooterContainer.Link>

                    <FooterContainer.Link href="#">Ways to Watch</FooterContainer.Link>

                    <FooterContainer.Link href="#">Coporate Information</FooterContainer.Link>

                    <FooterContainer.Link href="#">Netflix Originals</FooterContainer.Link>
                ...
                <FooterContainer.Column>
                    ...
                    <FooterContainer.Link href="#">Redeem Gift Cards</FooterContainer.Link>
                ...
                <FooterContainer.Column>
                    ...
                    <FooterContainer.Link href="#">Cookie Preferences</FooterContainer.Link>
